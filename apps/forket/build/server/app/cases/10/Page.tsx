...
function FancyTextBoundary(props) {
    ...
    return (<>
      {children && (<template type="forket/children" id="f_55" data-c="FancyText">
          {children}
        </template>)}
      <template type="forket/start/f_55" data-c="FancyText"></template>
      <FancyText {...props} children={children}/>
      <template type="forket/end/f_55" data-c="FancyText"></template>
...
function InspirationGeneratorBoundary(props) {
    ...
    const children = props.children;
    return (<>
      {children && (<template type="forket/children" id="f_56" data-c="InspirationGenerator">
          {children}
        </template>)}
      <template type="forket/start/f_56" data-c="InspirationGenerator"></template>
      <InspirationGenerator {...props} children={children}/>
      <template type="forket/end/f_56" data-c="InspirationGenerator"></template>
