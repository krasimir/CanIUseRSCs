...
export function ServerComponent({ params }: { params: { caseId: string } }) {
  const Case = routes[params.caseId as keyof typeof routes] || (() => <div>Not Found</div>);
  return <main className="flex min-h-screen flex-col items-center justify-center"><Case /></main>;
}
