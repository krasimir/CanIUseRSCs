...
})({"2gSM9":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "3e009ac3d80a9732";
"use strict";
...
},{}],"4w9XE":[function(require,module,exports,__globalThis) {
var _client = require("@parcel/rsc/client");
"use client-entry";
// Hydrate initial RSC payload embedded in the HTML.
let updateRoot = (0, _client.hydrate)({
    ...
    async callServer (id, args) {
        ...
        const { result, root } = await (0, _client.fetchRSC)(location.pathname, {
            method: 'POST',
            headers: {
                'rsc-action-id': id
            },
...
},{"@parcel/rsc/client":"aUVs0"}],"aUVs0":[function(require,module,exports,__globalThis) {
/* @jsxRuntime automatic */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setServerCallback", ()=>setServerCallback);
parcelHelpers.export(exports, "hydrate", ()=>hydrate);
parcelHelpers.export(exports, "fetchRSC", ()=>fetchRSC);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
var _client = require("react-server-dom-parcel/client");
var _client1 = require("rsc-html-stream/client");
var _client2 = require("react-dom/client");
function setServerCallback(cb) {
    return (0, _client.setServerCallback)(cb);
}
// Stream in initial RSC payload embedded in the HTML.
let initialRSCPayload;
function RSCRoot({ value, cb }) {
    initialRSCPayload ??= (0, _client.createFromReadableStream)((0, _client1.rscStream));
...
function hydrate(options) {
    if (options?.callServer) setServerCallback(options.callServer);
    if (options?.onHmrReload) window.addEventListener('parcelhmrreload', (e)=>{
        e.preventDefault();
        options?.onHmrReload?.();
    });
    let root;
    (0, _react.startTransition)(()=>{
        root = (0, _client2.hydrateRoot)(document, /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(RSCRoot, {}, void 0, false, {
            fileName: "node_modules/@parcel/rsc/src/client.tsx",
            lineNumber: 41,
            columnNumber: 34
        }, this), options);
    });
    return (value, cb)=>{
        (0, _react.startTransition)(()=>{
            root?.render(/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(RSCRoot, {
                value: value,
                cb: ()=>{
                    cb?.();
                    cb = undefined;
...
async function fetchRSC(url, options) {
    ...
    const response = fetch(url, {
        ...
        body: options && 'body' in options ? await (0, _client.encodeReply)(options.body, {
            temporaryReferences,
            signal: options?.signal
        }) : undefined
    });
    return (0, _client.createFromFetch)(response, {
        temporaryReferences
    });
}

},{"react/jsx-dev-runtime":"gk00R","react":"h4Eti","react-server-dom-parcel/client":"gvSUm","rsc-html-stream/client":"7nJOh","react-dom/client":"95u2F","@parcel/transformer-js/src/esmodule-helpers.js":"65j14"}],"gk00R":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("ee51401569654d91");

},{"ee51401569654d91":"gB85A"}],"gB85A":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
},{"58362d9d82be395f":"h4Eti"}],"gvSUm":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("a061e2b73f69cb45");

},{"a061e2b73f69cb45":"j5kOB"}],"j5kOB":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
(function() {
    ...
    function resolveModule(response, id, model) {
        var chunks = response._chunks, chunk = chunks.get(id), clientReference = JSON.parse(model, response._fromJSON);
    ...
    function callCurrentServerCallback(id, args) {
        if (!callServer) throw Error("No server callback has been registered. Call setServerCallback to register one.");
        return callServer(id, args);
    }
    ...
    var React = require("5e68f07d907982ef"), ReactDOM = require("78a2eae74577c2e3"), decoderOptions = {
        stream: !0
    }, bind = Function.prototype.bind, ReactDOMSharedInternals = ReactDOM.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler");
    Symbol.for("react.provider");
    ...
    }, replayConsoleWithCallStackInDEV = replayConsoleWithCallStack.react_stack_bottom_frame.bind(replayConsoleWithCallStack), callServer = null;
    (function(internals) {
    ...
    exports.createFromFetch = function(promiseForResponse, options) {
        var response = new ResponseInstance(null, null, null, callCurrentServerCallback, void 0, void 0, options && options.temporaryReferences ? options.temporaryReferences : void 0, findSourceMapURL, options ? !1 !== options.replayConsoleLogs : !0, options && options.environmentName ? options.environmentName : void 0);
    ...
    exports.createFromReadableStream = function(stream, options) {
        options = new ResponseInstance(null, null, null, callCurrentServerCallback, void 0, void 0, options && options.temporaryReferences ? options.temporaryReferences : void 0, findSourceMapURL, options ? !1 !== options.replayConsoleLogs : !0, options && options.environmentName ? options.environmentName : void 0);
        startReadingFromStream(options, stream);
        return getChunk(options, 0);
    };
    exports.createServerReference = function(id, exportName) {
        return createServerReference$1(id + "#" + exportName, callCurrentServerCallback, void 0, findSourceMapURL, exportName);
    };
...
},{"5e68f07d907982ef":"h4Eti","78a2eae74577c2e3":"btIan"}],"7nJOh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "rscStream", ()=>rscStream);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"65j14"}],"65j14":[function(require,module,exports,__globalThis) {
...
},{}],"95u2F":[function(require,module,exports,__globalThis) {
'use strict';
function checkDCE() {
...
},{"2b53550ce04dc092":"hspj6"}],"hspj6":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
},{"c31f9b99c1e288cf":"1zQBp","c4c4bc2113e5c77f":"h4Eti","772d609564cfd8f6":"btIan"}],"1zQBp":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("ef03b89c8fe2794e");

},{"ef03b89c8fe2794e":"eIoxV"}],"eIoxV":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
},{}]},["2gSM9"], null, "parcelRequireedff", {}, "../", "/", "http://localhost:1234")

//# sourceMappingURL=Home.d80a9732.js.map
