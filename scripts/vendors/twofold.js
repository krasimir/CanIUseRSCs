...
export async function setupTwofold(cases) {
  const Home = path.join(__dirname, "..", "..", "apps", "twofold", "app", "pages", "index.page.tsx");
  const Case = path.join(__dirname, "..", "..", "apps", "twofold", "app", "pages", "case", "$slug.page.tsx");
