...
export async function setupReactServer(cases) {
  const Home = path.join(__dirname, "..", "..", "apps", "react-server", "src", "page.jsx");
  const Case = path.join(__dirname, "..", "..", "apps", "react-server", "src", "case", "[id].page.jsx");
