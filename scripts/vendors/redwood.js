...
export async function setupRedwood(cases) {
  const Home = path.join(__dirname, "..", "..", "apps", "redwood", "src", "app", "pages", "Home.tsx");
  const Case = path.join(__dirname, "..", "..", "apps", "redwood", "src", "app", "pages", "Case.tsx");
