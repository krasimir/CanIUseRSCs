...
export async function setupWaku(cases) {
  const Home = path.join(__dirname, "..", "..", "apps", "waku", "src", "pages", "index.tsx");
  const Case = path.join(__dirname, "..", "..", "apps", "waku", "src", "pages", "case", "[caseId].tsx");
